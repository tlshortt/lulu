...
- [ ] **Phase 1: Foundation & Architecture** - Tauri + Svelte + cc-sdk project scaffold with database layer
- [ ] **Phase 2: Single Session Core** - One working Claude Code session with streaming output
...
- [ ] 01-08-PLAN.md — Runtime hardening + startup verification gap closure
...
**Success Criteria** (what must be TRUE):
  ...
  2. User sees dashboard list showing all sessions with name, status, and progress at a glance
...
|-------|----------------|--------|-----------|
| 1. Foundation & Architecture | 6/8 | In progress | - |
...
| 5. Session Lifecycle Control | 0/TBD | Not started | - |
| 6. Persistence & History | 0/TBD | Not started | - |
